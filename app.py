...
FONTI = {
    ...
    "corrieremezzo": "https://www.giornalone.it/prima-pagina-corriere-del-mezzogiorno-puglia/",
}
...
NOMI = {
    ...
    "corrieremezzo": "Corriere del Mezzogiorno (Puglia)",
}
...
def trova_url_immagine(pagina_url: str) -> str:
    ...
    # Prova a trovare l'immagine completa (con "pagina" o "prima" nel nome)
    pattern_principale = r'<img[^>]+(?:data-src|src)=["\']([^"\']*(?:pagina|prima)[^"\']*)["\']'
    match = re.search(pattern_principale, html, re.IGNORECASE)
